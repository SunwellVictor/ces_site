            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white">
                    <form action="{{ route('admin.products.store') }}" method="POST" class="space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="seo_description" 
                                              ...
                                              rows="3"
                                              maxlength="160"
                                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('seo_description') border-red-300 @enderror">{{ old('seo_description') }}</textarea>
                        ...
                        @if($files->count() > 0)
                            <div class="border-t pt-6">
                                <h3 class="text-lg font-medium text-gray-900 mb-4">Attach Files (Optional)</h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    @foreach($files as $file)
                                        <div class="flex items-center">
                                            ...
                                            <label for="file_{{ $file->id }}" class="ml-3 block text-sm text-gray-700">
                                                {{ $file->original_name }}
                                                <span class="text-gray-500">({{ number_format($file->size_bytes / 1024, 1) }} KB)</span>
                                            </label>
                                        </div>
                                    @endforeach
                                </div>
